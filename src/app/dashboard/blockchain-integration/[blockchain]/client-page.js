...
// Move client-side code to this component
export default function BlockchainIntegrationClient({ blockchainId }) {
  ...
  useEffect(() => {
    if (!blockchainData[blockchainId]) {
      router.push('/dashboard/blockchain-integration');
      return;
    }
    
    setBlockchainMetadata(blockchainData[blockchainId]);
            ...
            {step === 3 && (
              <div className="card glass-effect max-w-3xl mx-auto text-center">
                ...
                <div className="flex justify-center gap-4">
                  ...
                  <Link 
                    href={`/learn/validator-guides/${blockchainId}`}
                    className="button-outline"
                  >
                    View Full Guide
                  </Link>
